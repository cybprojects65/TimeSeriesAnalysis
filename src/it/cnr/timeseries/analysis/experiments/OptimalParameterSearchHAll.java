...
public class OptimalParameterSearchHAll {
	...
	public static void main(String args[]) throws Exception{
		...
		//File timeSeriesTable = new File("C:\\Users\\Utente\\Ricerca\\Experiments\\EcologicalModelling Solemon\\Validazione\\SSA\\Serie 2016-2018\\s22.csv");
		File originalTimeSeriesTable = new File("C:\\Users\\Utente\\Ricerca\\Experiments\\EcologicalModelling Solemon\\Data_EcologicalModelling_Solemon\\solemon\\ctc_index.csv");
		
		File timeSeriesTables [] = new File("C:\\Users\\Utente\\Ricerca\\Experiments\\EcologicalModelling Solemon\\Validazione\\SSA\\Serie 2016-2018\\").listFiles();
		
		for (int k = 0;k<timeSeriesTables.length;k++) {
		...
		TimeSeriesAnalysis tsae = new TimeSeriesAnalysis();
		try {
			tsae.process(timeSeriesTable, valuescolum, timecolumn, aggregationFunction, sensitivityP, fftwindowsamples, bestwindow, (float) besteigenthreshold, SSAPointsToForecast, forceUniformSampling, doFourierAnalysis, doSSA);
		}catch(Exception e) {
			e.printStackTrace();
		}
