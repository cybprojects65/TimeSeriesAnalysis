...
public class OptimalParameterSearchH10_Valid {

	
	public static void main(String args[]) throws Exception{
		
		File timeSeriesTable = new File("C:\\Users\\Utente\\Ricerca\\Experiments\\EcologicalModelling Solemon\\Validazione\\SSA\\Serie 2016-2018\\s10.csv");
		
		double trueValue = 86.6337356567383;
